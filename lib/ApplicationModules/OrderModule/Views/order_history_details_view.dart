...
class OrderHistoryDetailView extends StatefulWidget {
  final int index;

  const OrderHistoryDetailView({super.key, required this.index});

  @override
  State<OrderHistoryDetailView> createState() => _OrderHistoryDetailViewState();
}

class _OrderHistoryDetailViewState extends State<OrderHistoryDetailView> {
  ...
  void initState() {
    ...
    orderViewModel.getCustomerOnId(
        id: orderViewModel.ordehistoryrList.value[widget.index].customerId);
    getDetails = orderViewModel.getDetailOrders(
        id: orderViewModel.ordehistoryrList.value[widget.index].orderId);
    if (orderViewModel.ordehistoryrList.value[widget.index].orderStatus ==
        "success") {
      setState(() {
        delevired = true;
      });
                            ...
                            ? profileViewModel.localCurrentUserList.value[0]
                                ...
                                ? GestureDetector(
                                    onTap: () async {
                                      await http
                                          .get(Uri.parse(
                                              "${Token.apiHeader}updateStatus/${orderViewModel.ordehistoryrList.value[widget.index].orderId}"))
                                          .then((value) {
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      TextView(
                                        text:
                                            "${orderViewModel.ordehistoryrList.value[widget.index].businessName}",
                                        fontSize: 14,
                                        fontWeight: FontWeight.w400,
                                        color: AppColors.black,
                                      ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      TextView(
                                        text:
                                            "${orderViewModel.ordehistoryrList.value[widget.index].businessContact}",
                                        fontSize: 14,
                                        fontWeight: FontWeight.w400,
                                        color: AppColors.black,
                                      ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextView(
                                          text:
                                              "${orderViewModel.ordehistoryrList.value[widget.index].businessAddress}",
                                          fontSize: 14,
                                          fontWeight: FontWeight.w400,
                                          color: AppColors.black,
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      TextView(
                                        text:
                                            "${orderViewModel.ordehistoryrList.value[widget.index].shippingDate}"
                                                .substring(0, 10),
                                        fontSize: 14,
                                        fontWeight: FontWeight.w400,
                                        color: AppColors.black,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      TextView(
                                        text:
                                            "${orderViewModel.ordehistoryrList.value[widget.index].totalItems} Items purchased",
                                        fontSize: 14,
                                        fontWeight: FontWeight.w400,
                                        color: AppColors.black,
                                      ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      TextView(
                                        text:
                                            "${orderViewModel.ordehistoryrList.value[widget.index].orderNo}",
                                        fontSize: 14,
                                        fontWeight: FontWeight.w400,
                                        color: AppColors.black,
                                      ),
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      TextView(
                                        text:
                                            "Items (${orderViewModel.ordehistoryrList.value[widget.index].totalItems})",
                                        fontSize: 14,
                                        fontWeight: FontWeight.w400,
                                        color: AppColors.black,
                                      ),
                                      TextView(
                                        text:
                                            "${Token.curency}${orderViewModel.ordehistoryrList.value[widget.index].totalItemPrice}",
                                        fontSize: 14,
                                        fontWeight: FontWeight.w400,
                                        color: AppColors.black,
                                      ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      TextView(
                                        text:
                                            "${Token.curency}${orderViewModel.ordehistoryrList.value[widget.index].shippingOrder}",
                                        fontSize: 14,
                                        fontWeight: FontWeight.w400,
                                        color: AppColors.black,
                                      ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      TextView(
                                        text:
                                            "${Token.curency}${orderViewModel.ordehistoryrList.value[widget.index].totalAmount}",
                                        fontSize: 14,
                                        fontWeight: FontWeight.w700,
                                        color: AppColors.mainColor,
                                      ),
